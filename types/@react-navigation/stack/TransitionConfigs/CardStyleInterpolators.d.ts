/**
 * Flowtype definitions for CardStyleInterpolators
 ...
 */
declare export function forHorizontalIOS(
  x: StackCardInterpolationProps
): StackCardInterpolatedStyle;

/**
 * Standard iOS-style slide in from the bottom (used for modals).
 */
declare export function forVerticalIOS(
  x: StackCardInterpolationProps
): StackCardInterpolatedStyle;
