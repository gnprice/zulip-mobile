...
export class NotificationListener {
  ...
  /** Private. */
  handleNotificationOpen: ((notification: Notification) => void) = (notification: Notification) => {
   ...
   */
  handleDeviceToken: ((deviceToken: mixed) => Promise<void>) = async (deviceToken: mixed) => {
  ...
  /** Private. */
  handleIOSRegistrationFailure: ((err: NotificationRegistrationFailedEvent) => void) = (err: NotificationRegistrationFailedEvent) => {
