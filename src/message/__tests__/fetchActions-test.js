  ...
  describe('fetchMessages', () => {
    ...
    describe('success', () => {
      ...
      test('message fetch success action is dispatched, messages are returned', async () => {
        ...
        // Non-matching `avatar_url` fields have caused the following
        // error (see https://github.com/facebook/jest/issues/10408):
        //
        // TypeError: Cannot assign to read only property 'Symbol(context)' of object '[object URL]'
