...
var rnPostMessageIsReady = function rnPostMessageIsReady() {
...
var pollForPostMessage = function pollForPostMessage() {
  if (rnPostMessageIsReady()) {
    for (var i = 0; i < sendMessageQueue.length; i++) {
      sendMessage(sendMessageQueue[i]);
    }
  } else {
