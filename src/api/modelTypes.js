...
export type User = {|
   ...
   *
   * Note: Currently, we don't store some related fields:
   * `avatar_source`, `avatar_url_medium`, and `avatar_version`. If we
   * add these, we should try to avoid `avatar_url` falling out of
   * sync with them.
   */
