...
describe('getAutocompletedText', () => {
  ...
  test('can autocomplete users', () => {
    expect(getAutocompletedText('@ab', 'abcd', selection)).toEqual(
      '@**abcd** ',
    );
  });
  ...
  test('can autocomplete more complicated text', () => {
    ...
    expect(
      getAutocompletedText('@**word** @w', 'word word', selection),
    ).toEqual('@**word** @**word word** ');
  ...
  test('get autocompleted text for middle text autocomplete', () => {
    ...
    expect(getAutocompletedText(':abSome text', 'abcd', selection)).toEqual(
      ':abcd: Some text',
    );
  });
});
