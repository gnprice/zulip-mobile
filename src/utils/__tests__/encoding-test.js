...
describe('base64ToHex', () => {
  test('correctly converts a base64 string to a hex string', () => {
    const hex =
      'A8348A93A834938AF31348124D2392123192D23AB45C63092EA353BDFE2379DC';
...
describe('xorHexStrings', () => {
  test('correctly XORs two hex strings of the same length', () => {
    const hex1 =
      'A8348A93A834938AF31348124D2392123192D23AB45C63092EA353BDFE2379DC';
    const hex2 =
      'FEA3914A39410903458238420142388DABEE932FE021CD23C024D324EEEEEEEE';
  ...
  test('throws an error if inputs differ in length', () => {
    const hex1 =
      'A8348A93A834938AF31348124D2392123192D23AB45C63092EA353BDFE2379DC';
    const hex2 =
      'FEA3914A39410903458238420142388DABEE932FE021CD23C024D324EEEEEEE';
