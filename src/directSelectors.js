...
export const getIsActive = (state: GlobalState): boolean =>
  state.session.isActive;
export const getIsOnline = (state: GlobalState): boolean =>
  state.session.isOnline;
export const getDebug = (state: GlobalState): Debug => state.session.debug;
export const getIsHydrated = (state: GlobalState): boolean =>
  state.session.isHydrated;

export const getCanCreateStreams = (state: GlobalState): boolean =>
...
export const getUserGroups = (state: GlobalState): UserGroup[] =>
  state.userGroups;

export const getUsers = (state: GlobalState): User[] => state.users;

export const getFetching = (state: GlobalState): FetchingState =>
  state.fetching;
...
export const getAllMessages = (state: GlobalState): MessageState =>
  state.messages;

export const getNav = (state: GlobalState): NavigationState => state.nav;

export const getSettings = (state: GlobalState): SettingsState =>
  state.settings;
...
export const getPresence = (state: GlobalState): PresenceState =>
  state.presence;

export const getOutbox = (state: GlobalState): Outbox[] => state.outbox;

export const getUnreadStreams = (state: GlobalState): StreamUnreadItem[] =>
  state.unread.streams;

export const getUnreadPms = (state: GlobalState): UnreadPmsState =>
  state.unread.pms;

export const getUnreadHuddles = (state: GlobalState): UnreadHuddlesState =>
  state.unread.huddles;

export const getUnreadMentions = (state: GlobalState): UnreadMentionsState =>
  state.unread.mentions;

export const getRealm = (state: GlobalState): RealmState => state.realm;

export const getRealmEmoji = (state: GlobalState): RealmEmojiState =>
  state.realm.emoji;

export const getNavigationRoutes = (state: GlobalState): Object[] =>
  state.nav.routes;

export const getNavigationIndex = (state: GlobalState): number =>
  state.nav.index;
