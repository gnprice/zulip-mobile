...
declare function afterAuth<A, B, R>(f: (Auth, A, B, ...mixed[]) => R): (A, B) => R;
declare function afterAuth<A, B, C, R>(f: (Auth, A, B, C, ...mixed[]) => R): (A, B, C) => R;
declare function afterAuth<A, B, C, D, R>(
  f: (Auth, A, B, C, D, ...mixed[]) => R,
): (A, B, C, D) => R;
declare function afterAuth<A, B, C, D, E, R>(
  f: (Auth, A, B, C, D, E, ...mixed[]) => R,
): (A, B, C, D, E) => R;
declare function afterAuth<A, B, C, D, E, F, R>(
  f: (Auth, A, B, C, D, E, F, ...mixed[]) => R,
): (A, B, C, D, E, F) => R;
declare function afterAuth<A, B, C, D, E, F, G, R>(
  f: (Auth, A, B, C, D, E, F, G, ...mixed[]) => R,
): (A, B, C, D, E, F, G) => R;
declare function afterAuth<A, B, C, D, E, F, G, H, R>(
  f: (Auth, A, B, C, D, E, F, G, H, ...mixed[]) => R,
): (A, B, C, D, E, F, G, H) => R;
